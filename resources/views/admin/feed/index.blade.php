                                ...
                                <tbody>
                                    @foreach ($feeds as $feed)
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset($feed->image) }}" alt="{{ $feed->title }}"
                                                    width="70px" height="70px" style="border-radius: 5px;"></td>
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ route('admin.feeds.show', $feed->id) }}" data-bs-toggle="tooltip" title=""
                                                        class="btn btn-link btn-info btn-lg" data-original-title="Show Task">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
