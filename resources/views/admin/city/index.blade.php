                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <input id="arbicName" type="text" class="form-control" name="name_arabic"
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <input id="englishName" type="text" class="form-control" name="name_english"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                <a href="{{ route('admin.cities.edit', $city->id) }}" data-bs-toggle="tooltip" title=""
