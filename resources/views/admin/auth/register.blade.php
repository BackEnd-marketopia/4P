                ...
                <div class="card bg-white shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form method="POST" action="{{ route('registerStore') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('password_confirmation') ? ' has-danger' : '' }} mb-3 col-md-6">
                                <div class="input-group input-group-alternative">
                                    <input class="form-control{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}"
                                        placeholder="{{ __('message.Confirm Password') }}" type="password" name="password_confirmation"
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }} mb-3 col-md-12">
                                <div class="input-group input-group-alternative">
                            ...
                            <div class="form-group{{ $errors->has('category_id') ? ' has-danger' : '' }} mb-3 col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('city_ids') ? ' has-danger' : '' }} mb-3 col-md-12">
                                <label for="city_ids" class="form-label">{{ __('message.Cities') }}</label>
                                <select class="form-control{{ $errors->has('city_ids') ? ' is-invalid' : '' }}" name="city_ids[]" id="city_ids" multiple
                                    required>
                            ...
                            <div class="form-group{{ $errors->has('whatsapp') ? ' has-danger' : '' }} mb-3 col-md-6">
                                <div class="input-group input-group-alternative">
                            ...
                            <div class="form-group{{ $errors->has('facebook') ? ' has-danger' : '' }} mb-3 col-md-6">
                                <div class="input-group input-group-alternative">
                            ...
                            <div class="form-group{{ $errors->has('instagram') ? ' has-danger' : '' }} mb-3 col-md-6">
                                <div class="input-group input-group-alternative">
                            ...
                            <div class="form-group{{ $errors->has('google_map_link') ? ' has-danger' : '' }} mb-3">
                                <div class="input-group input-group-alternative">
                                    <input class="form-control{{ $errors->has('google_map_link') ? ' is-invalid' : '' }}"
                                        placeholder="{{ __('message.Google Map Link') }}" type="text" name="google_map_link"
                                        value="{{ old('google_map_link') }}" autofocus>
                                </div>
